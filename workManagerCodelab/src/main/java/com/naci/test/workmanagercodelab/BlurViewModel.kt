...
import com.naci.test.workmanagercodelab.workers.BlurWorker
import com.naci.test.workmanagercodelab.workers.CleanupWorker
import com.naci.test.workmanagercodelab.workers.SaveImageToFileWorker
...
class BlurViewModel(application: Application) : ViewModel() {
    ...
    internal fun applyBlur(blurLevel: Int) {
        ...
        val constraintsCharger = Constraints.Builder()
            .setRequiresCharging(true)
            .build()

        val saveRequest = OneTimeWorkRequestBuilder<SaveImageToFileWorker>()
            .addTag(TAG_OUTPUT)
            .setConstraints(constraintsCharger)
            .build()
