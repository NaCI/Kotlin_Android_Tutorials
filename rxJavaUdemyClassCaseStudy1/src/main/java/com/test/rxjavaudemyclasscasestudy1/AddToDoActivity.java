...
import com.test.rxjavaudemyclasscasestudy1.adapter.MyDialog;
...
public class AddToDoActivity extends AppCompatActivity {
    ...
    private TextInputEditText goalContent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        goalContent = (TextInputEditText) findViewById(R.id.etTask);
