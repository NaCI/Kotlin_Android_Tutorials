package com.test.rxjavaudemyclasscasestudy1;
...
import com.test.rxjavaudemyclasscasestudy1.adapter.RecyclerTouchListener;
import com.test.rxjavaudemyclasscasestudy1.adapter.ToDoListAdapter;
import com.test.rxjavaudemyclasscasestudy1.data.ToDoDataManager;
import com.test.rxjavaudemyclasscasestudy1.data.ToDoListItem;
        ...
        compositeDisposable.add(
                observable
                        ...
                        .subscribeWith(new DisposableObserver<ToDoListItem>() {
                            @Override
                            public void onNext(@NonNull ToDoListItem item) {
                                goalsList.add(item);
                            }
