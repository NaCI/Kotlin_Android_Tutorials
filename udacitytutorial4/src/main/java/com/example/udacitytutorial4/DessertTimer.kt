...
class DessertTimer(lifecycle: Lifecycle) : LifecycleObserver {
    ...
    /**
     * The method below will be called automatically when the observed lifecycle go in on start form
     */
    ...
    /**
     * The method below will be called automatically when the observed lifecycle go in on stop form
     */
